...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2942e35c57b4b1a633eb52a7cc7b178ccdc8a2cb46c6290999390fd9476ff14a.js',function(){input.required=false;search();});}
